...
export const TOOLBAR_ITEMS: ToolbarItem[] = [
  { label: 'H1', title: '一级标题', action: { type: 'prefix', before: '# ', placeholder: '标题' } },
  { label: 'H2', title: '二级标题', action: { type: 'prefix', before: '## ', placeholder: '标题' } },
  { label: 'B', title: '粗体', action: { type: 'wrap', before: '**', after: '**', placeholder: '粗体文字' } },
  { label: 'I', title: '斜体', action: { type: 'wrap', before: '*', after: '*', placeholder: '斜体文字' } },
  { label: '`', title: '行内代码', action: { type: 'wrap', before: '`', after: '`', placeholder: 'code' } },
  { label: '```', title: '代码块', action: { type: 'block', before: '```\n', after: '\n```', placeholder: '代码' } },
  { label: '•', title: '无序列表', action: { type: 'prefix', before: '- ', placeholder: '列表项' } },
  { label: '1.', title: '有序列表', action: { type: 'prefix', before: '1. ', placeholder: '列表项' } },
  { label: '>', title: '引用', action: { type: 'prefix', before: '> ', placeholder: '引用文字' } },
  { label: '☑', title: '任务列表', className: 'text-base', action: { type: 'prefix', before: '- [ ] ', placeholder: '待办事项' } },
  { label: '🔗', title: '链接', action: { type: 'wrap', before: '[', after: '](url)', placeholder: '链接文字' } },
